...
const Nfts: Nft[] = [
  ...
  },
  {
    ...
    images: {
      ...
      ipfs: `${IPFS_GATEWAY}/QmZGqWaovULNEJNToxBCGnGjh27JQkAyadS6AW4J4Lzf3XBp/easter-caker.png`,
    },
  ...
  },
  {
    ...
    images: {
      ...
      ipfs: `${IPFS_GATEWAY}/QmZGqWaovULNEJNToxBCGnGjh27JQkAyadS6AW4J4Lzf3XBp/easter-flipper.png`,
    },
  ...
  },
  {
    ...
    images: {
      ...
      ipfs: `${IPFS_GATEWAY}/QmZGqWaovULNEJNToxBCGnGjh27JQkAyadS6AW4J4Lzf3XBp/easter-storm.png`,
    },
  ...
  {
    name: 'Churro',
    description: "Don't let that dopey smile deceive you... Churro's a master JNTo chef!",
    images: {
      lg: 'churro-lg.png',
      md: 'churro-md.png',
      sm: 'churro-sm.png',
  ...
  {
    name: 'Dollop',
    description: "Nommm... Oh hi, I'm just meditating on the meaning of JNTo.",
    images: {
      lg: 'dollop-lg.png',
      md: 'dollop-md.png',
      sm: 'dollop-sm.png',
  ...
  {
    name: 'Twinkle',
    description: "Three guesses what's put that twinkle in those eyes! (Hint: it's JNTo)",
    images: {
      lg: 'twinkle-lg.png',
      md: 'twinkle-md.png',
      sm: 'twinkle-sm.png',
