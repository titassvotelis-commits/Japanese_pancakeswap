...
export const mainnetTokens = {
  jnto: new Token(
    MAINNET,
    '0x97Ac67A9D3a90893b786739546FaAB43ef00530C',
    18,
    'JNTo',
    'JNToken',
    'https://optimuswap.io/',
  ...
  /** Legacy Optimus (OPT) — used by MasterChef pools 0–1 on BSC */
  opt: new Token(
    MAINNET,
  ...
  mdx: new Token(MAINNET, '0x9C65AB58d8d978DB963e63f2bfB7121627e3a739', 18, 'MDX', 'MDX Token', ''),
  wbnb: new Token(
    MAINNET,
