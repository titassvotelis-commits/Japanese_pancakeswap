...
/** Refresh wallet balances every N blocks (~9s on BSC) instead of every block. */
export const WALLET_BALANCE_FETCH_OPTIONS: ListenerOptions = { blocksPerFetch: 3 }
