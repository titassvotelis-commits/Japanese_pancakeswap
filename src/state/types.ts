...
import { State as NftMarketState } from './nftMarket/types'
...
export interface DeserializedFarm extends DeserializedFarmConfig {
  tokenPriceBusd?: string
  quoteTokenPriceBusd?: string
  displayLpTotalInQuoteToken?: BigNumber
...
export interface LotteryRound extends LotteryRoundGenerics {
  ...
  priceTicketInOpt: BigNumber
  discountDivisor: BigNumber
  amountCollectedInOpt: BigNumber
  strPerBracket: string[]
  countWinnersPerBracket: string[]
  rewardsBreakdown: string[]
}

export interface LotteryResponse extends LotteryRoundGenerics {
  priceTicketInOpt: SerializedBigNumber
  discountDivisor: SerializedBigNumber
  amountCollectedInOpt: SerializedBigNumber
  strPerBracket: SerializedBigNumber[]
