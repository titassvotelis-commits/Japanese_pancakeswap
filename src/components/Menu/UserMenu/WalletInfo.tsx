...
import { getFullDisplayBalance, formatNativeBalance } from 'utils/formatBalance'
...
const WalletInfo: React.FC<WalletInfoProps> = ({ hasLowBnbBalance, onDismiss }) => {
  ...
  const { balance: cakeBalance, fetchStatus: cakeFetchStatus } = useTokenBalance(tokens.jnto.address)
    ...
    <>
      ...
      <Flex alignItems="center" justifyContent="space-between">
        ...
        {fetchStatus !== FetchStatus.SUCCESS ? (
          ...
          <Text>{formatNativeBalance(balance, 18, 8)}</Text>
        )}
      </Flex>
      <Flex alignItems="center" justifyContent="space-between">
        <Text color="textSubtle">{t('JNTo Balance')}</Text>
      ...
      <Flex alignItems="center" justifyContent="space-between" mb="24px">
        ...
        {usdtFetchStatus !== FetchStatus.SUCCESS ? (
          ...
          <Text>{getFullDisplayBalance(usdtBalance, tokens.usdt.decimals, 3)}</Text>
        )}
      </Flex>
