import { Currency, CurrencyAmount, currencyEquals, ETHER, WETH } from '@pancakeswap/sdk'
...
export default function useWrapCallback(
  ...
  const fetchedBalance = useCurrencyBalance(
    account ?? undefined,
    inputBalance === undefined ? inputCurrency : undefined,
  )
  const balance = inputBalance ?? fetchedBalance
