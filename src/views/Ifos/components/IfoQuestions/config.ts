const config = [
  {
    ...
    description: [
      'In the Basic Sale, every user can commit a maximum of about 100 USD worth of JNTo-BNB LP Tokens. We calculate the maximum LP amount about 30 minutes before each IFO. The Basic Sale has no participation fee.',
      'In the Unlimited Sale, there’s no limit to the amount of JNTo-BNB LP Tokens you can commit. However, there’s a fee for participation: see below.',
    ],
  },
  {
  ...
  },
  {
    ...
    description: [
      'We burn it. The JNTo-BNB LP tokens from the participation fee will be decomposed. We will then use the BNB portion to market buy the JNTo equivalent, and finally throw all of the JNTo into the weekly token burn.',
    ],
  },
  {
    title: 'How can I get an achievement for participating in the IFO?',
    description: [
      'You need to contribute a minimum of about 10 USD worth of JNTo-BNB LP Tokens to either sale.',
