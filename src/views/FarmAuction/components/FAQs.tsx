        ...
        <StyledCard mr={[null, null, null, null, '24px']} mb={['24px', null, null, null, '0']}>
          ...
          <CardBody p="0 24px 24px">
            ...
            <FoldableText title={t('Step 2: Await whitelisting')} mt="24px">
              <Box color="textSubtle">
                ...
                <List>
                  <FaqLi>
                    {t(
                      'Community Farm qualifiers will be asked to provide the address of the wallet which you’ll use for bidding JNTo in the auction.',
                    )}
                  </FaqLi>
            ...
            <FoldableText title={t('Step 3: During the auction')} mt="24px">
              ...
              <Text color="textSubtle">
                {t(
                  'You can then commit JNTo to bid during the auction, competing against other project for one of the available farms.',
                )}
              </Text>
            </FoldableText>
            <FoldableText title={t('Step 4: After the auction')} mt="24px">
              <Text color="textSubtle">
                {t('If your bid was not successful, you can reclaim your JNTo on this page.')}
              </Text>
              <Text color="textSubtle">
                {t(
                  'If your bid was successful, your farm will begin at the specified time. The JNTo you bid will not be returned to you and will be added to our weekly JNTo burn.',
                )}
              </Text>
              <Text color="textSubtle">
              ...
              <Text color="textSubtle">
                {t(
                  'If two or more projects bid the exact same JNTo amount and are contending for a spot in the winning bidders, their bids may be invalidated.',
                )}
              </Text>
            </FoldableText>
          </CardBody>
