...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and JNTo pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and JNTo pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from JNTo pool', data)
  }
