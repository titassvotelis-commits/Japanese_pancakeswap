...
const StyledFlex = styled(Flex)`
  ...
  background: linear-gradient(0deg, #262626 0%, ${BRAND.deepest} 37%);
  border-radius: 4px;
  align-items: center;
`
...
const CakeDataRow = () => {
  ...
  const burnedBalance = getBalanceNumber(useBurnedBalance(tokens.jnto.address))
  ...
  return (
    <Grid>
      ...
      <StyledFlex flexDirection="column">
        ...
        <Text color="textSubtle">{t('New JNTo/block')}</Text>
