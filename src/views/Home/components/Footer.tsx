    ...
    <>
      ...
      <Wrapper>
        ...
        <Text textAlign="center" color="white">
          {t('Connect your crypto wallet to start investing.')}
        </Text>
        ...
        <Flex>
          {account ?
            <Button variant="secondary" width="100%" onClick={handleLogout} color="#fff" style={{ background: "#3F3F3F" }}>
              {t('Disconnect Wallet')}
            </Button> :
            <UnlockButton style={{ background: "#3F3F3F", borderRadius: "24px", color: "#fff", width: "100%" }} />
          }
