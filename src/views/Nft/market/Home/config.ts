const config = [
  ...
  },
  {
    ...
    description: [
      '100% of all platform fees taken by PancakeSwap from sales are used to buy back and BURN JNTo tokens in our weekly JNTo burns.',
      'Platform fees: 2% is subtracted from NFT sales on the market. Subject to change.Collection fees: Additional fees may be taken by collection creators, once those collections are live. These will not contribute to the JNTo burns.',
    ],
  },
]
