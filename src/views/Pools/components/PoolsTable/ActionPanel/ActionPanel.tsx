...
const ActionPanel: React.FC<ActionPanelProps> = ({ account, pool, userDataLoaded, expanded, breakpoints }) => {
  ...
  const isMetaMaskInScope = isMetaMaskProvider()
        ...
        {account && isMetaMaskInScope && tokenAddress && (
          <Flex mb="8px" justifyContent={['flex-end', 'flex-end', 'flex-start']}>
            <Button
              ...
              p="0"
              height="auto"
              onClick={() => addTokenToMetamask(tokenAddress, earningToken.symbol, earningToken.decimals)}
            >
      ...
      <ActionContainer>
        {showSubtitle && (
          <Text mt="4px" mb="16px" color="textSubtle">
            {isAutoVault ? t('Automatic restaking') : `${t('Earn')} JNTo ${t('Stake').toLocaleLowerCase()} JNTo`}
          </Text>
        )}
        {pool.isAutoVault ? (
