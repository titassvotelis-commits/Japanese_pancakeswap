  ...
  const steps: Step[] = [
    {
      ...
      title: t('Buy Tickets'),
      subtitle: t('Prices are set when the round starts, equal to 5 USD in JNTo per ticket.'),
    },
    {
      ...
      <GappedFlex flexDirection={['column', 'column', 'column', 'row']}>
        <Flex flex="2" flexDirection="column">
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t('100% of the JNTo paid by people buying tickets that round goes back into the prize pools.')}
              </Text>
            </li>
          </BulletList>
          <Heading my="16px" scale="md">
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t(
                  'After every round, if nobody wins in one of the prize brackets, the unclaimed JNTo for that bracket rolls over into the next round and are redistributed among the prize pools.',
                )}
              </Text>
            </li>
          </BulletList>
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t(
                  'An average total of 35,000 JNTo from the treasury is added to lottery rounds over the course of a week. This JNTo is of course also included in rollovers! Read more in our guide to ',
                )}
                <InlineLink href="https://docs.optimuswap.io/tokenomics/JNTo/JNTo-tokenomics">
                  {t('JNTo Tokenomics')}
                </InlineLink>
              </Text>
            </li>
