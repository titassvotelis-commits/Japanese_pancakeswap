...
const NextDrawCard = () => {
  ...
  const { endTime, amountCollectedInOpt, userTickets, status } = currentRound
  ...
  const prizeInBusd = amountCollectedInOpt.times(cakePriceBusd)
      ...
      <>
        ...
        {prizeInBusd.isNaN() ? (
          ...
          <Balance
            ...
            textAlign={['center', null, null, 'left']}
            unit=" JNTo"
            value={getBalanceNumber(amountCollectedInOpt)}
            decimals={0}
          />
        )}
      </>
